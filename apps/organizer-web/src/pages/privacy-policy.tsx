    ...
    <LegalShell title="Privacy Policy" updated="August 7, 2026">
      ...
      <Section heading="3. How We Share Information">
        ...
        <ul className="list-disc space-y-1 pl-6">
          <li>
            <strong>Razorpay</strong> — payment processing, refunds, and fraud prevention.
          </li>
          <li>
            <strong>Cloudinary</strong> — image and media hosting.
          </li>
          <li>
            <strong>Google</strong> — Google Sign-in (if you choose it).
          </li>
          <li>
            <strong>Cashfree</strong> — payouts to community organizers.
          </li>
          <li>
            <strong>Supabase</strong> — hosting, authentication, database, and realtime
      ...
      <Section heading="4. Retention and Deletion">
        <p>
